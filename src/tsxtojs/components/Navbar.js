...
const ic_navi_back = __importDefault(require("../images/ic_navi_back.svg"));
function Navbar() {
    ...
    return (react_1.default.createElement("nav", { id: "naviHeader" },
        react_1.default.createElement("span", { onClick: handleBackButtonClick },
            react_1.default.createElement("img", { className: "imgNaviBack", src: ic_navi_back.default, alt: "" })),
