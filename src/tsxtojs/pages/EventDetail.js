        ...
        react_1.default.createElement("div", { className: "tabHeader" },
            react_1.default.createElement("div", { className: "wrap" },
                react_1.default.createElement("div", { className: "tab" },
                    react_1.default.createElement("span", { className: activeTab === 'contents' ? 'active' : 'deactive', onClick: () => setActiveTab('contents') }, "\uC774\uBCA4\uD2B8 \uB0B4\uC6A9\uBCF4\uAE30")),
                react_1.default.createElement("div", { id: "contentsTab" }, activeTab === 'contents' && react_1.default.createElement(EventContent_1.default, null)),
                react_1.default.createElement("div", { className: "tab" },
                    react_1.default.createElement("span", { className: activeTab === 'register' ? 'active' : 'deactive', onClick: () => setActiveTab('register') }, "\uC774\uBCA4\uD2B8 \uCC38\uC5EC\uD558\uAE30")),
                react_1.default.createElement("div", { id: "registerTab" }, activeTab === 'register' && react_1.default.createElement(EventRegister_1.default, null))))));
}
